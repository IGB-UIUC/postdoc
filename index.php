...
function generateName(){
	...
	<tr>
		...
		<td> <input type='text' name='formdata[Research Goals][name]' size='100' style='width:800px'></input>
		 </td>
	<tr>

	    <tr>
                <td width='109px'>Faculty Supervisor </td>
                <td> <input type='text' name='formdata[Research Goals][supervisor]' size='100' style='width:800px'></input>
                 </td>
            <tr>

            <tr>
                <td width='109px'>Faculty Mentor</td>
                <td> <input type='text' name='formdata[Research Goals][mentor1]' size='100' style='width:800px'></input>
                 </td>
            <tr>

            <tr>
                <td width='109px'>Faculty Mentor</td>
                <td> <input type='text' name='formdata[Research Goals][mentor2]' size='100' style='width:800px'></input>
                 </td>
            <tr>

	    <tr>
                <td width='109px'>Theme Leader</td>
                <td> <input type='text' name='formdata[Research Goals][theme]' size='100' style='width:800px'></input>
                 </td>
            <tr>
    ...
    foreach($headings as $heading => $head){
      ...
      $table = "
          ...
          <tr><td colspan=3 style='background-color:lightgray'></td> </tr>
            <tr><td colspan=3><b> {$id}. $head (Fill out as many as desired)</b></td> </tr>
                    <tr><td colspan=3 style='background-color:lightgray'></td> </tr>";
      ...
      for($i =1; $i <= 3; $i++){
            ...
            $table .="
            <tr><td> Goal #{$i}</td> <td><input type='text' class='goal' maxlength='100' name='{$goal}'></input></td><td>Anticipated Completion Date</td></tr>
